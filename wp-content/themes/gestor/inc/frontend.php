...
function gestor_enqueue_scripts(){
	...
	wp_register_style('gestor-reserves', get_template_directory_uri() . '/assets/css/gestor.css', array('bootstrap'), '1.0');
	...
	wp_register_script('gestor-reserves', get_template_directory_uri() . '/assets/js/gestor.js', array('jquery', 'bootstrap'), '1.0', true);
